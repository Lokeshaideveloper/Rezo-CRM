...
interface Props { contact: Contact | null; onClose: () => void; onSave: () => void; defaultAccountId?: string }

export default function ContactModal({ contact, onClose, onSave, defaultAccountId }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    const payload = { ...form, account_id: form.account_id || null, linkedin_url: form.linkedin_url || null }
    const { error } = contact
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input className="input" value={form.linkedin_url} onChange={e => set('linkedin_url', e.target.value)} placeholder="https://linkedin.com/in/priya" />
          </div>
